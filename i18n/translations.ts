...
export const translations = {
    fr: {
        ...
        how_to_unblock: "Voir comment deébloquer",
        ...
        // Fixed: Removed redundant duplicate property 'no_group_msg'
        ...
        select_capsules: "Sélection des Modules",
        no_capsules_select: "Aucun module à sélectionner.",
        save: "Enregistrer",
        ...
        confirm_import_override: "Voulez-vous remplacer votre profil et vos modules actuels ? Cette action est irréversible.",
        import_success: "{count} module(s) importé(s) avec succès !",
        ...
        export_select_success: "{count} module(s) exportée(s).",
        no_selection_export: "Aucun module sélectionné.",
        select_at_least_one: "Veuillez d'abord sélectionner au moins un module.",
        logout_success: "Déconnexion réussie.",
        
        // Email Content
        email_subject_single: "Partage de module Memoraid : {title}",
        email_subject_plural: "Partage de {count} modules Memoraid",
        email_body_capsule: "MODULE",
        ...
        capsules_selected: "module(s) sélectionné(s)",
        next: "Suivant",
        back: "Retour",
        new: "Nouveau",
        ...
        sync_cloud: "Synchronisation de vos modules vers le cloud...",
        ...
        capsule_deleted: "a été supprimé.",
        ...
        share_success: "Module partagé avec le groupe.",
    ...
    en: {
        ...
        select_capsules: "Select Modules",
        no_capsules_select: "No modules to select.",
        save: "Save",
        ...
        confirm_import_override: "Do you want to replace your current profile and modules? This action is irreversible.",
        import_success: "{count} module(s) imported successfully!",
        ...
        export_select_success: "{count} module(s) exported.",
        no_selection_export: "No modules selected.",
        select_at_least_one: "Please select at least one module first.",
        logout_success: "Logout successful.",

        // Email Content
        email_subject_single: "Memoraid Module Share: {title}",
        email_subject_plural: "Sharing {count} Memoraid Modules",
        email_body_capsule: "MODULE",
        ...
        capsules_selected: "module(s) selected",
        next: "Next",
        back: "Back",
        new: "New",
        ...
        overview: "Overview",
        students: "Students",
        assignments: "Assignments & Modules",
        ...
        sync_cloud: "Syncing your modules to the cloud...",
        offline_save: "Saved offline. Pending sync.",
        capsule_created: "Module created successfully!",
        ...
        share_success: "Module shared with the group.",
