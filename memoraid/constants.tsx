...
/**
 * ILLUSTRATION AMPOULE LUMINEUSE SUBTILE AVEC LOGO MEMORAID ET SYNAPSES
 */
        ...
        <div className="relative group scale-110">
            ...
            <div className="animate-hum">
                <svg width="150" height="200" viewBox="0 0 120 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative z-10 overflow-visible">
                    ...
                    {/* --- LE FILAMENT LOGO MEMORAID + SYNAPSES --- */}
                    <g transform="translate(60, 60)" className="animate-electric-flicker-soft">
                        <g transform="scale(2.1) translate(-12, -12)">
                            {/* Les deux parties du bouclier (logo) */}
                            ...
                            {/* Points synaptiques orange intégrés au bouclier */}
                            <g className="animate-twinkle">
                                <circle cx="6.5" cy="8" r="1" fill="#f59e0b" />
                                <circle cx="6.5" cy="12" r="1" fill="#fbbf24" />
                                <circle cx="6.5" cy="16" r="1" fill="#f59e0b" />
                                
                                <circle cx="17.5" cy="8" r="1" fill="#fbbf24" />
                                <circle cx="17.5" cy="12" r="1" fill="#f59e0b" />
                                <circle cx="17.5" cy="16" r="1" fill="#fbbf24" />

                                <circle cx="12" cy="7" r="1.3" fill="#f59e0b" />
                                <circle cx="12" cy="17" r="1.3" fill="#fde047" />
                            </g>
                        </g>
                        
                        {/* Support vertical discret */}
                        <path d="M0,25 L0,30" stroke="#10b981" strokeWidth="1.5" strokeDasharray="2 2" opacity="0.3" />
                    </g>
