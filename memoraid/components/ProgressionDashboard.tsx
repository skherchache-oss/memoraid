                ...
                <div className="space-y-4">
                    ...
                    <div className="pt-2">
                        <div className="relative h-24 w-full border-b border-l border-slate-200 dark:border-zinc-700">
                            ...
                            <div className="absolute -bottom-5 left-0 text-[10px] text-slate-400 uppercase tracking-tighter">{t('time')}</div>
                            <div className="absolute top-0 -right-2 text-[10px] text-slate-400 uppercase tracking-tighter">{t('memory')}</div>
                        </div>
